# -*- coding: utf-8 -*-
#
# Test History Server documentation build configuration file, created by
...
filename = os.path.join(os.path.dirname(__file__), '..', 'test_history_server', 'VERSION')
...
def linkcode_resolve(domain, info):
    ...
    if os.path.isfile(os.path.join(os.path.dirname(__file__), '..', rel_filename + '.py')):
        return "https://github.com/KarrLab/test_history_server/blob/master/{}.py".format(rel_filename)
    else:
        return "https://github.com/KarrLab/test_history_server/blob/master/{}/__init__.py".format(rel_filename)
...
#
# html_title = u'Test History Server v0.0.3'
...
htmlhelp_basename = 'testhistoryserverdoc'
...
latex_documents = [
    (master_doc, 'testhistoryserver.tex', u'Test History Server Documentation',
...
man_pages = [
    (master_doc, 'testhistoryserver', u'Test History Server Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'testhistoryserver', u'Test History Server Documentation',
     author, 'testhistoryserver', 'One line description of project.',
     'Miscellaneous'),
]
