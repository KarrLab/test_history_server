# Django settings for test_history_server project.
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'cWvLJwXB',               # Not used with sqlite3.
...
ALLOWED_HOSTS = ['tests.karrlab.org']
...
ROOT_URLCONF = 'test_history_server.urls'
